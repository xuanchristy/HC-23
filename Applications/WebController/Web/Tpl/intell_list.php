...
<div class="modal fade" id="unbindModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<ul class="list-group">
	  ...
	  <li class="list-group-item">
	    <p style="line-height: 40px;" id="<?php echo $key; ?>"><span contenteditable="true"><?php echo $value; ?></span></p>
		   <div class="kaiguan">
...
$(function(){
	...
	// 自定义名称
	$('#macnameModal').on('shown.bs.modal', function () {
	...
	// 传输数据
	$("#tranceModal").on('shown.bs.modal', function(){
